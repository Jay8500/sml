...
export class ApprovalsComponent {
  ...
  public loanStatusRemarks = "Loan Status Remarks";
  ...
  getErrorMessages(ctrl: string) {
    switch (ctrl) {
      ...
      case "approvalstatus":
        this.errorMessages.approvalstatus = [undefined, null, ''].includes(this.createMaster.approvalstatus) ? 'Surity name is required' : "";
        break;
        // case "surityaadhar":
