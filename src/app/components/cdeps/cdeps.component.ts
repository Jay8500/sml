...
@Component({
  selector: 'app-cdeps',
  templateUrl: './cdeps.component.html',
  styleUrls: ['./cdeps.component.css'],
  providers: [MessageService]
})
export class CdepsComponent {
  ...
  saveProduct() {
    ...
    savePayload['flag'] = 'S';
    this.loading = true;
    let loginJson = this._service.postApi('createDepartment', 'postEndPoint', savePayload)
